...
public class Lovebite implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage("§c" + languageManager.getMessage("commands.help.lovebite"));
            return true;
        }
        ...
        player.sendMessage("§e" + languageManager.replacePlaceholders(languageManager.getMessage("commands.lovebite.success"), replacements));
        
        replacements.put("player", player.getName());
        target.sendMessage("§a" + languageManager.replacePlaceholders(languageManager.getMessage("commands.lovebite.success"), replacements));
