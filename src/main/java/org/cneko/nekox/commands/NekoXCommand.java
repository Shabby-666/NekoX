...
public class NekoXCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (args.length == 0) {
            ...
            sender.sendMessage("§e版本: 2.0-RELEASE");
            sender.sendMessage("§e此改版作者: _Chinese_Player_");
            sender.sendMessage("§e输入 /nekoxhelp 查看帮助");
            sender.sendMessage("§e===== 原作者 =====");
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "version":
            case "v":
                sender.sendMessage("§6NekoX 版本 §e2.0-RELEASE");
                break;
            default:
                sender.sendMessage("§c未知命令参数！输入 /nekoxhelp 查看帮助");
                break;
        }
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("§e/lovebite <玩家> - 给玩家一个爱的咬痕");
        ...
        sender.sendMessage("§e/attention <玩家> - 吸引玩家的注意");
        ...
        sender.sendMessage("§e/health - 猫娘恢复自己和主人的生命值");
